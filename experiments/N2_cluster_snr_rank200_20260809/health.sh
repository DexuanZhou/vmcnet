#!/bin/bash
#SBATCH --job-name=N2-r200-snr-health
#SBATCH --account=def-ortner
#SBATCH --time=00:20:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
# The measured d=200 peak is 13.41 GiB, so a 20-GiB slice is sufficient for
...
RUN=${ROOT}/health_e200
META=${ROOT}/metadata/health_e200
...
[[ $(wc -l < "${RUN}/energy.txt") -eq 200 ]] || exit 4

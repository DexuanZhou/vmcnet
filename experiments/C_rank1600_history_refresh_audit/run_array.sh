#!/bin/bash
#SBATCH --job-name=C-hist-refresh
...
ROOT=${ROOT:-/scratch/dexuan1/runs/C_wssr_rank1600_history_refresh_audit_20260802}
...
python experiments/C_rank1600_history_refresh_audit/audit.py \
  --run "${SOURCE_RUN}" \
  --epoch "${SOURCE_EPOCH}" \

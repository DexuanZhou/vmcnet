#!/bin/bash
#SBATCH --job-name=C-mlevel-comp-eval
...
if (( SLURM_ARRAY_TASK_ID < 5 )); then
  PERIOD=20; I=${SLURM_ARRAY_TASK_ID}
else
  PERIOD=100; I=$((SLURM_ARRAY_TASK_ID - 5))
fi
EPOCH=$((101000 + 1000 * I))
SOURCE=/scratch/dexuan1/runs/C_wssr_rank1600_multilevel_comp_period${PERIOD}_E5000
RUN=/scratch/dexuan1/runs/C_wssr_rank1600_multilevel_comp_frozen/period${PERIOD}_epoch${EPOCH}

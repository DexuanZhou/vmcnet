...
case "${SLURM_ARRAY_TASK_ID}" in
  0) METHOD=spring; MODE=direct_L2; FINAL=train_L2 ;;
  1) METHOD=spring; MODE=multilevel; FINAL=train_L2_to2000 ;;
  2) METHOD=wssr_warm_svd_right; MODE=direct_L2; FINAL=train_L2 ;;
  3) METHOD=wssr_warm_svd_right; MODE=multilevel; FINAL=train_L2_to2000 ;;
  *) exit 2 ;;
esac

SOURCE=${ROOT}/pilot/${METHOD}/${MODE}/${FINAL}
RUN=${ROOT}/frozen/${METHOD}/${MODE}

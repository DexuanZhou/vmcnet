#!/bin/bash
# Paired light frozen evaluation for the transition-refresh test.
#SBATCH --job-name=C-WSSR-ML-refresh-E
...
case "${SLURM_ARRAY_TASK_ID}" in
  0) REPLICATE=0; MODE=warm2 ;;
  1) REPLICATE=0; MODE=refresh40 ;;
  2) REPLICATE=1; MODE=warm2 ;;
  3) REPLICATE=1; MODE=refresh40 ;;
  *) exit 2 ;;
esac

SOURCE=${ROOT}/seed${REPLICATE}/${MODE}/continue_to1200
RUN=${ROOT}/frozen/seed${REPLICATE}/${MODE}

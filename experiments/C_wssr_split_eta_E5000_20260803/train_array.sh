#!/bin/bash
#SBATCH --job-name=C-split-eta-E5k
...
ROOT=/scratch/dexuan1/runs/C_wssr_split_eta_E5000_20260803

case "${SLURM_ARRAY_TASK_ID}" in
  0) ARM=A_etaS095_etaG0;   ETA_S=0.95; ETA_G=0.0  ;;
  1) ARM=B_etaS0_etaG095;   ETA_S=0.0;  ETA_G=0.95 ;;
  2) ARM=C_etaS095_etaG095; ETA_S=0.95; ETA_G=0.95 ;;
  3) ARM=D_etaS0_etaG0;     ETA_S=0.0;  ETA_G=0.0  ;;

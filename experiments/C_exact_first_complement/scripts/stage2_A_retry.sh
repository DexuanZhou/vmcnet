#!/bin/bash
#SBATCH --job-name=C-exactfirst-A-retry
...
RUN=/scratch/dexuan1/runs/C_exact_first_complement/stage2_500_retry2/A_warm_c0
META=${RUN}.metadata
...
python experiments/fir_n4096_smoke/scripts/timed_reload_launcher.py \
 ...
 --config.vmc.optimizer.wssr_warm_svd_right.exact_first=False --config.vmc.optimizer.wssr_warm_svd_right.exact_reference_diagnostics=False --config.vmc.optimizer.wssr_warm_svd_right.update_diagnostics=True

#!/bin/bash
#SBATCH --job-name=C-exactfirst-eval-r2
...
case "${SLURM_ARRAY_TASK_ID}" in
  0) V=A_warm_c0; SOURCE=/scratch/dexuan1/runs/C_exact_first_complement/stage2_500_retry2/${V} ;;
  1) V=B_exact_c0; SOURCE=/scratch/dexuan1/runs/C_exact_first_complement/stage2_500_retry1/${V} ;;
  2) V=C_exact_c1e4; SOURCE=/scratch/dexuan1/runs/C_exact_first_complement/stage2_500_retry1/${V} ;;
esac
RUN=/scratch/dexuan1/runs/C_exact_first_complement/frozen_eval_retry2/${V}

#!/bin/bash
#SBATCH --job-name=C-ssi-initial-r1
...
set -euo pipefail
OUT=/scratch/dexuan1/vmcnet/experiments/C_exact_first_complement/results/ssi_convergence/initial_retry1
...
python experiments/C_exact_first_complement/ssi_snapshot_replay.py initial --output "$OUT"

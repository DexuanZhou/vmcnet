...
case "${SYSTEM}" in
  N2)
    ...
    RUN=/scratch/dexuan1/runs/N2_R2016_WSSR_rank1600_semimf_smoke_20260809
  ...
  H2O)
    ...
    CHECKPOINT=${SOURCE}/checkpoints/5000.npz
    RUN=/scratch/dexuan1/runs/H2O_WSSR_rank1600_semimf_smoke_20260809
...
purpose=ordinary WSSR rank1600 semi-matrix-free memory gate
system=${SYSTEM}

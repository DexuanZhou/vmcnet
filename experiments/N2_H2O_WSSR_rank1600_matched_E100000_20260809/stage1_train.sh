...
case "${SYSTEM}" in
  N2)
    ...
    RUN=/scratch/dexuan1/runs/N2_R2016_WSSR_rank1600_matched_E100000_semimf_20260809_stage1
    RELOAD_USE_CONFIG=True
    MOLECULE_ARGS=()
    ;;
  H2O)
    SOURCE=/scratch/dexuan1/runs/H2O_kfac_pre5000_N2matched_20260807
    RUN=/scratch/dexuan1/runs/H2O_WSSR_rank1600_matched_E100000_semimf_20260809_stage1
...
purpose=matched ${SYSTEM} ordinary WSSR rank1600 stage 1
system=${SYSTEM}

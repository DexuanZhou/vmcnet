...
HERE=/scratch/dexuan1/vmcnet/experiments/N2_R2016_EF_device_E1000_20260807
SNAPSHOT=/scratch/dexuan1/vmcnet_snapshot_N2_EF_device_E1000_20260807
REPO=/scratch/dexuan1/vmcnet
SOURCE=/scratch/dexuan1/runs/old/N2_R2016/e100000_followup/N2eq/N2eq_kfac_pre5000
ROOT=/scratch/dexuan1/runs/N2_R2016_EF_device_E1000_20260807
...
if [[ "${OPTIMIZER}" == spring ]]; then
  vmc-molecule "${COMMON_ARGS[@]}" \
    ...
    --config.vmc.optimizer.spring.mu=0.95 \

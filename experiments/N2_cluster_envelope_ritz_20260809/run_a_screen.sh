#!/bin/bash
#SBATCH --job-name=N2-env-ritz-A200
...
HERE=/scratch/dexuan1/vmcnet/experiments/N2_cluster_envelope_ritz_20260809
SNAPSHOT=${SNAPSHOT:-/scratch/dexuan1/vmcnet_snapshot_cluster_envelope_ritz_20260809_retry1}
REPO=/scratch/dexuan1/vmcnet
SOURCE=/scratch/dexuan1/runs/old/N2_R2016/e100000_followup/N2eq/N2eq_kfac_pre5000
ROOT=${ROOT:-/scratch/dexuan1/runs/N2_cluster_envelope_ritz_A200_20260809_retry1}
ARM=${ARM:-A_ritz96_alpha0}
MODE=${MODE:-cluster_envelope_ritz}
RUN=${ROOT}/${ARM}

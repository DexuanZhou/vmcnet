#!/bin/bash
#SBATCH --job-name=C-gtransport-eval
...
case "${SLURM_ARRAY_TASK_ID}" in
  0) ARM=expG02_vanilla;     SEED=0 ;;
  1) ARM=expG02_transported; SEED=0 ;;
  2) ARM=expG02_vanilla;     SEED=1 ;;
  3) ARM=expG02_transported; SEED=1 ;;
...
test -f "${RUN}/eval/local_energies.txt"

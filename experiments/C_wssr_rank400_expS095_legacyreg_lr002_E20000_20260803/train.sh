#!/bin/bash
#SBATCH --job-name=C-r400-expS-oldreg
...
ROOT=/scratch/dexuan1/runs/C_wssr_rank400_expS095_legacyreg_lr002_E20000_20260803
...
export WSSR_PROTOCOL_LEARNING_RATE=0.02
export WSSR_PROTOCOL_EXACT_FIRST=True
export WSSR_PROTOCOL_LEGACY_REGULARIZATION=True
export WSSR_PROTOCOL_QUESTION=rank400_expS095_current_gradient_exactfirst_legacyreg_lr002_C_E20000

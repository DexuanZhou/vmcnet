...
case "${SYSTEM}" in
  N2)
    SOURCE=/scratch/dexuan1/runs/N2_R2016_WSSR_rank1600_dualcap_E100000_20260810_stage1
    RUN=/scratch/dexuan1/runs/N2_R2016_WSSR_rank1600_dualcap_E100000_20260810
    ;;
  H2O)
    SOURCE=/scratch/dexuan1/runs/H2O_WSSR_rank1600_dualcap_E100000_20260810_stage1
    RUN=/scratch/dexuan1/runs/H2O_WSSR_rank1600_dualcap_E100000_20260810
    ;;
...
purpose=matched ${SYSTEM} metric-aware dual-cap tail WSSR rank1600 stage 2 and frozen evaluation
source_run=${SOURCE}

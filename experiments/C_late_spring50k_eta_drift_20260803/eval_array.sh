#!/bin/bash
#SBATCH --job-name=C-late50k-eval
...
case "${SLURM_ARRAY_TASK_ID}" in
  0) ARM=spring55k; SOURCE=${SPRING}; CK=55000.npz ;;
  1) ARM=eta03; SOURCE=${ROOT}/train/eta03; CK=5000.npz ;;
  2) ARM=eta08; SOURCE=${ROOT}/train/eta08; CK=5000.npz ;;
  3) ARM=eta095; SOURCE=${ROOT}/train/eta095; CK=5000.npz ;;
  *) echo "unexpected task ${SLURM_ARRAY_TASK_ID}" >&2; exit 2 ;;
esac

FROZEN_DIR=${FROZEN_DIR_OVERRIDE:-frozen}
FROZEN_SEED=${FROZEN_SEED_OVERRIDE:-0}
RUN=${ROOT}/${FROZEN_DIR}/${ARM}

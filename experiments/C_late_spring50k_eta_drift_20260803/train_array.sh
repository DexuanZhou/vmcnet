...
ROOT=/scratch/dexuan1/runs/C_late_spring50k_eta_drift_20260803
SOURCE_EPOCH=50000
UPDATES=5000
...
question=does_long_WSSR_memory_stop_being_toxic_at_a_late_SPRING_checkpoint
...
nchains=1000
rank=1600
learning_rate_local=0.006666666666666667
learning_decay_rate_local=0.0000166666666666667
equivalent_global_schedule=0.04/(1+1e-4*(50000+s))
eta_bias_correction=true
...
vmc-molecule \
  ...
  --config.vmc.optimizer.wssr_warm_svd_right.learning_rate=0.006666666666666667 \
  --config.vmc.optimizer.wssr_warm_svd_right.learning_decay_rate=0.0000166666666666667 \

#!/bin/bash
#SBATCH --job-name=C-r1600-eval100k
...
set -euo pipefail
SOURCE=/scratch/dexuan1/runs/wssr_C_4096_kfac1000_E50000_grid/rank1600_warm2_eta08_lr0002
RUN=/scratch/dexuan1/runs/C_wssr_rank1600_E50000_frozen_eval_burn100k_n8192
META=${RUN}_metadata
...
export XLA_PYTHON_CLIENT_PREALLOCATE=false EVAL_PRNG_TAG=2026072101
...
python experiments/fir_wssr4096_protocol/eval_seeded_launcher.py \
 --reload.logdir=${SOURCE} --reload.checkpoint_relative_file_path=checkpoints/50000.npz \

#!/bin/bash
#SBATCH --job-name=N2-R2016-SPRING-lr001
...
ROOT=${ROOT_OVERRIDE:-/scratch/dexuan1/runs/N2_R2016_spring_lr001_mu099_after_kfac5000_E100000}
META=${ROOT}_metadata
...
ion_positions_z_bohr=(-1.008,+1.008)
...
vmc-molecule \
  ...
  --config.vmc.optimizer.spring.learning_rate=0.001 \

#!/bin/bash
#SBATCH --job-name=C-r1600-b005-E5k
...
RUN=/scratch/dexuan1/runs/C_wssr_rank1600_eta03_lr004_beta005_continue_E5000
META=${RUN}_metadata
...
vmc-molecule \
  ...
  --config.vmc.optimizer.wssr_warm_svd_right.adaptive_complement_beta=0.05 \

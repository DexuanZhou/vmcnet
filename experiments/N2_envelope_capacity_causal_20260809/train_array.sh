#!/bin/bash
#SBATCH --job-name=N2-env-H96-E96-E1000
...
HERE=/scratch/dexuan1/vmcnet/experiments/N2_envelope_capacity_causal_20260809
REPO=/scratch/dexuan1/vmcnet
SOURCE=/scratch/dexuan1/runs/old/N2_R2016/e100000_followup/N2eq/N2eq_kfac_pre5000
ROOT=/scratch/dexuan1/runs/N2_envelope_capacity_causal_20260809_retry1
...
HISTORIES=(1 3)
SNAPSHOTS=(
  /scratch/dexuan1/vmcnet_snapshot_cluster_envelope_h96_20260809
  /scratch/dexuan1/vmcnet_snapshot_cluster_envelope_e96_20260809
)
ARM=${ARMS[$SLURM_ARRAY_TASK_ID]}
RANK=${RANKS[$SLURM_ARRAY_TASK_ID]}
HISTORY=${HISTORIES[$SLURM_ARRAY_TASK_ID]}
...
{
  echo "arm=${ARM}"
  echo "current_rank=${RANK}"
  echo "envelope_history=${HISTORY}"
  echo "maximum_envelope_capacity=96"
  echo "rotation_error_feedback=false"

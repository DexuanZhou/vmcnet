#!/bin/bash
#SBATCH --job-name=C-r1600-lam2-eval
...
RUN=/scratch/dexuan1/runs/C_wssr_rank1600_fixed_lambda_stage2_E2000_frozen/epoch102000
test -f "${SOURCE}/checkpoints/102000.npz"

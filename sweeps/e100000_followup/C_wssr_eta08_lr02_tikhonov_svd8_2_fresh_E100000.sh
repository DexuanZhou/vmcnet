#!/bin/bash
#SBATCH --job-name=C-wssr-e08-l02-s2-fresh-e100k
...
export SYSTEM=C RUN_NAME=C_wssr_eta08_lr02_tikhonov_svd8_2_fresh_E100000_spin42
export SOURCE_DIR=/scratch/dexuan1/runs/pilot/C/C_kfac_pre1000_1 SOURCE_EPOCH=1000 RESUME_OPTIMIZER=False
export LEARNING_RATE=0.02 ETA=0.8 NORM_CONSTRAINT=0.001 MAXITER_WARM=2

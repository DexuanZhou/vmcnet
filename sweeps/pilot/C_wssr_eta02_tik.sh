#!/bin/bash
#SBATCH --job-name=C-wssr-eta02-tik
...
export SYSTEM=C RUN_NAME=wssr_eta02_tik
export ION_POS='((0.0,0.0,0.0),)'
export PRE_DIR=/scratch/dexuan1/runs/pilot/C/C_kfac_pre1000_1 PRE_EPOCH=1000
export LEARNING_RATE=0.002 ETA=0.2 RANK=1600 STORAGE_RANK=1600 WORKING_RANK=1600 MAXITER_WARM=2

#!/bin/bash
#SBATCH --job-name=N2eq-wssr-lr001
...
export SYSTEM=N2eq RUN_NAME=wssr_lr001
...
export LEARNING_RATE=0.001 ETA=0.8 RANK=1600 STORAGE_RANK=1600 WORKING_RANK=1600 MAXITER_WARM=2

#!/bin/bash
#SBATCH --job-name=N2eq-wssr-eta05-tik
...
export SYSTEM=N2eq RUN_NAME=wssr_eta05_tik
...
export LEARNING_RATE=0.002 ETA=0.5 RANK=1600 STORAGE_RANK=1600 WORKING_RANK=1600 MAXITER_WARM=2

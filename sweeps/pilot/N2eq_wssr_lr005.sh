#!/bin/bash
#SBATCH --job-name=N2eq-wssr-lr005
...
export SYSTEM=N2eq RUN_NAME=wssr_lr005
...
export LEARNING_RATE=0.005 ETA=0.8 RANK=1600 STORAGE_RANK=1600 WORKING_RANK=1600 MAXITER_WARM=2

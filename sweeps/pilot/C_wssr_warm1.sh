...
export SYSTEM=C RUN_NAME=wssr_warm1
export ION_POS='((0.0,0.0,0.0),)'
export PRE_DIR=/scratch/dexuan1/runs/pilot/C/C_kfac_pre1000_1 PRE_EPOCH=1000
export LEARNING_RATE=0.002 ETA=0.8 RANK=1600 STORAGE_RANK=1600 WORKING_RANK=1600 MAXITER_WARM=1

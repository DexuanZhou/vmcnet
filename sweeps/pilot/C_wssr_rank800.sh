#!/bin/bash
#SBATCH --job-name=C-wssr-rank800
...
export SYSTEM=C RUN_NAME=wssr_rank800
export ION_POS='((0.0,0.0,0.0),)'
export PRE_DIR=/scratch/dexuan1/runs/pilot/C/C_kfac_pre1000_1 PRE_EPOCH=1000
export LEARNING_RATE=0.002 ETA=0.8 RANK=800 STORAGE_RANK=800 WORKING_RANK=800 MAXITER_WARM=2

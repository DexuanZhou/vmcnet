#!/bin/bash
#SBATCH --job-name=N2eq-wssr-e03-l002-c002-e100k
...
export SYSTEM=N2eq RUN_NAME=N2eq_wssr_eta03_lr0002_tikhonov_C002_E100000
export SOURCE_DIR=/scratch/dexuan1/runs/e100000_followup/N2eq/N2eq_kfac_pre5000 SOURCE_EPOCH=5000 RESUME_OPTIMIZER=False
export LEARNING_RATE=0.002 ETA=0.3 NORM_CONSTRAINT=0.002 MAXITER_WARM=2
